                                ...
                                <div className="details">
                                    ...
                                    <div className="product-btn">
                                        <button
                                            ...
                                            className="add-to-cart-btn mt-2 p-4 bg-gradient-to-r from-red-500 via-pink-500 to-blue-500 hover:from-red-600 hover:via-pink-600 hover:to-blue-600 text-white font-bold py-3 px-5 rounded-lg transition duration-300 ease-in-out transform hover:scale-105">
                                            Add to Cart
                                        </button>
                                    </div>
                                </div>
